...
//
function Camera(wcCenter, wcWidth, viewportArray,colorArray,edge) {
...
Camera.prototype.setRoundgroundColor = function (newColor) { this.roundColor = newColor; };
Camera.prototype.getRoundgroundColor = function () { return this.roundColor; };
...
Camera.prototype.setupViewProjection = function () {
    ...
    // Step A2: set up the corresponding scissor area to limit the clear area
        ...
        gl.scissor(this.mViewport[0]-this.edge, // x position of bottom-left corner of the area to be drawn
               this.mViewport[1]-this.edge, // y position of bottom-left corner of the area to be drawn
               this.mViewport[2]+2*this.edge, // width of the area to be drawn
               this.mViewport[3]+2*this.edge);// height of the area to be drawn
    // Step A3: set the color to be clear
    gl.clearColor(this.roundColor[0], this.roundColor[1], this.roundColor[2], this.roundColor[3]);  // set the color to be cleared
